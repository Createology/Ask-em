    ...
    return (
      <Container>
        ...
        <Header style={{ backgroundColor: "#E65100" }}>
          ...
          <Text style={styles.headerStyle}>Add Survey</Text>
        </Header>
        ...
        <ScrollView>
          <View style={{ flex: 1 }}>
            ...
            <Picker
              note
              mode="dropdown"
              style={{ width: undefined, marginBottom: -30, marginLeft: '40%', marginBottom: 0, }}
            ...
            <Picker
              note
              mode="dropdown"
              style={{ width: undefined, marginBottom: -30, marginLeft: '40%', }}
